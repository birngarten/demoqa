...
//        myTestBody.put("password","JQ3iPpTEKTLjSQJ!");
    ...
    public void TC0102(){
        ...
        obj.setPassword("JQ3iPpTEKTLjSQJ!");
        assertEquals(myPostResponse(obj).prettyPrint(),"false");
    }
    @Test
    public void TC0103(){
        obj.setUserName("123456");
        ...
        assertEquals(myJason.getString("message"),"User not found!");
    }
    @Test
    public void TC0104(){
    ...
    @Test
    public void TC0104v2(){
        myTestBody.put("userName",null);
        myTestBody.put("password","");
        ReusableMethods.myPostResponse(myTestBody,endpoint).prettyPrint();
        myPostResponse(myTestBody).then().assertThat().statusCode(HttpStatus.SC_BAD_REQUEST);
        myJason = myPostResponse(myTestBody).jsonPath();
    }
}
